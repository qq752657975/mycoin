...
func (m *MemberWalletDao) UpdateFreeze(ctx context.Context, conn mydb.DbConn, memberId int64, symbol string, money float64) error {
...
func (m *MemberWalletDao) UpdateWallet(ctx context.Context, conn mydb.DbConn, id int64, balance float64, frozenBalance float64) error {
