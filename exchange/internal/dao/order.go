...
func (e *ExchangeOrderDao) Save(ctx context.Context, conn mydb.DbConn, order *model.ExchangeOrder) error {
...
func NewExchangeOrderDao(db *mydb.MsDB) *ExchangeOrderDao {
